package org.example.proyectofinal480.Logica;
...
import org.example.proyectofinal480.Persistencia.*;
...
public class GestorBiblioteca {
    ...
    public void devolverArticulo(int idArticulo) throws Exception {
        ...
        if (fechaEsperada != null && hoy.isAfter(fechaEsperada)) {
            ...
            double recargoPorDia = 1.5; 
            double recargoTotal = diasRetraso * recargoPorDia;
